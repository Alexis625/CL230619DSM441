...
class TeacherShareNotice : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val categories = arrayOf("Estudiante", "Maestros", "Todos")
    ...
    fun shareNotice(view: View) {
        ...
        if (isUploading) {
            Toast.makeText(this, "Carga en progreso, por favor espera", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        if (imageUri != null) {
            ...
            imageRef.putFile(imageUri!!)
                .addOnSuccessListener { taskSnapshot ->
                    ...
                    imageRef.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        Toast.makeText(this, "Aviso compartido con exito", Toast.LENGTH_SHORT).show()
                        // Reset UI
                        resetUI()
                ...
                .addOnFailureListener { e ->
                    ...
                    Toast.makeText(this, "Fallo al cargar la imagen: ${e.message}", Toast.LENGTH_SHORT).show()
                    // Dismiss loading indicator and reset upload flag
                    progressDialog.dismiss()
                    isUploading = false
                }
            ...
            ref.setValue(notice)
            // Show success message
            Toast.makeText(this, "Aviso compartido exitosamente", Toast.LENGTH_SHORT).show()
            // Reset UI
            resetUI()
            // Dismiss loading indicator and reset upload flag
            progressDialog.dismiss()
