            ...
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    if (task.exception is FirebaseAuthUserCollisionException) {
                        ...
                        Toast.makeText(this, "No se pudo registrar. Inténtelo de nuevo más tarde.", Toast.LENGTH_SHORT).show()
                    }
        ...
        if (imageUri != null) {
            ...
            imageRef.putFile(imageUri!!)
                ...
                .addOnFailureListener { e ->
                    ...
                    Toast.makeText(this, "No se pudo cargar la imagen: ${e.message}", Toast.LENGTH_SHORT).show()
                    progressBar.visibility = View.GONE
                }
        } else {
    ...
    private fun addUserToDatabase(userId: String?, fullName: String, email: String, imageUrl: String) {
        ...
        userRef.setValue(userData)
            .addOnSuccessListener {
                ...
                Toast.makeText(this, "¡Regístro exitoso!", Toast.LENGTH_SHORT).show()
            ...
            .addOnFailureListener { e ->
                ...
                Toast.makeText(this, "No se pudo agregar el usuario a la base de datos: ${e.message}", Toast.LENGTH_SHORT).show()
                progressBar.visibility = View.GONE
            }
    }
